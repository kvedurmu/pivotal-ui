...
export const useBoundingClientRect = Klass => class BoundingClientRect extends mixin(React.PureComponent).with(Mounted) {
  ...
  getBoundingClientRect = () => this.state.container && this.state.container.getBoundingClientRect() || {};
