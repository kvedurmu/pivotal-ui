...
class TetherComponent extends Component {
  ...
  _registerEventListeners() {
    this.on('update', () => this.props.onUpdate && this.props.onUpdate.apply(this, arguments));

    this.on('repositioned', () => this.props.onRepositioned && this.props.onRepositioned.apply(this, arguments));
  }
